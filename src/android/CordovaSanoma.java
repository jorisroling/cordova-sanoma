...
import com.sanoma.socialize.GSObject;
import com.sanoma.socialize.GSResponse;
import com.sanoma.socialize.GSResponseListener;
import com.sanoma.socialize.android.GSAPI;
import com.sanoma.socialize.android.GSSession;
import com.sanoma.socialize.android.event.GSLoginUIListener;

public class CordovaSanoma extends CordovaPlugin {

    private static final String TAG = "CordovaSanoma";
        ...
        if ("initialize".equals(action)) {
            ...
            GSAPI.getInstance().showLoginUI(params, new GSLoginUIListener() {
                ...
                public void onLoad(Object context) {
                    Log.d(TAG, "sanoma loginUI was loaded");
                }

                @Override
                public void onError(GSResponse response, Object context) {
                    Log.d(TAG, "sanoma loginUI had an error - " + response.getErrorMessage());
                ...
                public void onClose(boolean canceled, Object context) {
                    Log.d(TAG, "sanoma loginUI was closed");
                }

                @Override
                public void onLogin(String provider, GSObject user, Object context) {
                    Log.d(TAG, "sanoma loginUI has logged in");
